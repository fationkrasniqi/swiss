        ...
        <table style="width:100%;border-collapse:collapse">
            <thead>
                <tr style="text-align:left;border-bottom:1px solid #e5e7eb">
                    ...
                    <th style="padding:10px">Service Date</th>
            ...
            <tbody>
                ...
                <tr style="border-bottom:1px solid #f3f4f6">
                    ...
                    <td style="padding:10px">{{ $c->phone_prefix }} {{ $c->phone_number }}</td>
                    ...
                    <td style="padding:10px">{{ $c->service_date ? \Carbon\Carbon::parse($c->service_date)->format('d M Y') : '-' }}</td>
